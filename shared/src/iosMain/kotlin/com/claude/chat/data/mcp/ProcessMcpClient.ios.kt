...
/**
 * iOS implementation of ProcessMcpClient
 * Note: Process launching is restricted on iOS. This is a placeholder implementation.
...
actual class ProcessMcpClient actual constructor(
    ...
    actual override suspend fun initialize(): Result<McpInitializeResult> {
        Napier.w("ProcessMcpClient is not supported on iOS. Use RemoteMcpClient for HTTP/SSE connections.")
        return Result.failure(UnsupportedOperationException("Process launching not supported on iOS"))
    }
